...
export default function MissionAdministrative() {
        ...
        <div className='missionAdministrative'>
            ...
            <div className="container-fluid">
                ...
                <div className="missionSynthesis__main">
                    <MissionTitle name="P. Hành Chính Tổng Hợp" isOpen={isOpenStatus} toggleCloseMission={setIsOpenMissionClosed} onClick={handleOpenStatus} />
                    {isOpenStatus &&
                        <div className="container-fluid">
