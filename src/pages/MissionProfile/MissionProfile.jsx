...
let data = [
    ...
    { id: 3, name: 'P. Lập hồ sơ di tích', path: '#' },
];
        ...
        <div className='missionAdministrative'>
            ...
            <div className="container-fluid">
                ...
                <div className="missionSynthesis__main">
                    <MissionTitle name="P. Lập hồ sơ di tích" isOpen={isOpenStatus} toggleCloseMission={setIsOpenMissionClosed} onClick={handleOpenStatus} />
                    {isOpenStatus &&
                        <div className="container-fluid">
