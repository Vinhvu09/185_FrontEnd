...
import filterIcon from '../../assets/svg/noti_filter.svg';
...
const filterList = [
    ...
    {
        name: 'Thông báo công văn'
    },
    {
        name: 'Thông báo nhiệm vụ'
    },
    {
        name: 'Thông báo trạng thái nhiệm vụ'
    },
    {
...
export default function NotificationPage() {
    ...
    return (
        <div className='notificationPage' style={{ height: '100%' }}>
            <div className="notificationGeneral --page">
                <div className="notificationGeneral__head">
                    <p>Thông báo</p>
                </div>
                <div className="notificationGeneral__tab">
                    <div className="left">
                        <div className={`tabItem ${isFull && 'active'}`} onClick={() => setIsFull(true)}>
                            <p>Tất cả</p>
                        </div>
                        <div className={`tabItem ${!isFull && 'active'}`} onClick={() => setIsFull(false)}>
                            <p>Chưa đọc</p>
                        </div>
                    </div>
                    <div className="right">
                        <div className={`readGroup ${isRealAll && 'active'}`} onClick={handleReadAll}>
                            <svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.456 0.454973C10.6673 0.253806 10.9485 0.142593 11.2402 0.144801C11.5319 0.147008 11.8114 0.262464 12.0196 0.466805C12.2279 0.671145 12.3486 0.948389 12.3563 1.24003C12.364 1.53168 12.2581 1.81491 12.061 2.02997L6.07597 9.51497C5.97305 9.62582 5.84885 9.71478 5.71077 9.77652C5.57269 9.83827 5.42357 9.87154 5.27235 9.87434C5.12112 9.87714 4.97087 9.84941 4.8306 9.79282C4.69033 9.73623 4.56292 9.65193 4.45597 9.54497L0.486968 5.57597C0.376438 5.47298 0.287785 5.34878 0.226297 5.21078C0.164809 5.07278 0.131747 4.92381 0.129081 4.77276C0.126416 4.6217 0.154203 4.47166 0.210785 4.33158C0.267366 4.19149 0.351583 4.06424 0.458411 3.95742C0.565239 3.85059 0.69249 3.76637 0.832572 3.70979C0.972654 3.65321 1.1227 3.62542 1.27375 3.62809C1.42481 3.63075 1.57378 3.66381 1.71178 3.7253C1.84977 3.78679 1.97398 3.87544 2.07697 3.98597L5.21797 7.12547L10.426 0.487973C10.4353 0.476392 10.4453 0.465373 10.456 0.454973ZM9.07597 8.16497L10.456 9.54497C10.5629 9.6517 10.6902 9.7358 10.8303 9.79225C10.9705 9.84871 11.1205 9.87636 11.2716 9.87356C11.4226 9.87076 11.5716 9.83757 11.7095 9.77596C11.8475 9.71435 11.9716 9.62559 12.0745 9.51497L18.0625 2.02997C18.17 1.92378 18.2551 1.79699 18.3126 1.65719C18.3701 1.51738 18.3988 1.36743 18.397 1.21628C18.3952 1.06514 18.363 0.915895 18.3023 0.77747C18.2416 0.639046 18.1536 0.514278 18.0436 0.410617C17.9336 0.306956 17.8038 0.226528 17.662 0.174137C17.5202 0.121746 17.3693 0.0984646 17.2183 0.105685C17.0674 0.112905 16.9194 0.150479 16.7832 0.216161C16.6471 0.281843 16.5256 0.374288 16.426 0.487973L11.2165 7.12547L10.489 6.39647L9.07447 8.16497H9.07597Z" fill="#1A48E9" />
                            </svg>
                            <p>Đánh dấu đã đọc tất cả</p>
                        </div>
                        <div className="filterGroup" style={{ position: 'relative' }} onClick={(e) => {
                            e.stopPropagation();
                            setIsPopupFilter(prev => !prev);
                        }}>
                            <p>Bộ lọc</p>
                            <img src={filterIcon} alt="icon" />
                            {isPopupFilter && <PopOver data={listFilter} setData={setListFilter} list={filterList} isType="filter" onClick={(e) => e.stopPropagation()} />}
                        </div>
                    </div>
                </div>
                <div className="notificationGeneral__list">
                    {isFull &&
                        <>
                            <NotificationItem notRead={!readEvery} svg={(
                                <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.66797 17.9259L6.40871 13.1852M6.40871 6.07408H20.6309H6.40871ZM20.6309 6.07408L15.8902 1.33334L20.6309 6.07408ZM20.6309 6.07408L15.8902 10.8148L20.6309 6.07408ZM15.8902 17.9259H1.66797H15.8902ZM1.66797 17.9259L6.40871 22.6667L1.66797 17.9259Z" stroke="#A56EF4" stroke-width="2.37037" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            )} mainColor="rgba(165, 110, 244, 0.15)" name="Thông báo chuyển trạng thái của nhiệm vụ" time="15 phút trước" />
                            <NotificationItem icon={circleCheck} mainColor="rgba(60, 213, 163, 0.15)" name="Thông báo chuyển trạng thái của nhiệm vụ" time="15 phút trước" />
                            <NotificationItem icon={exclamatory} mainColor=" rgba(230, 38, 20, 0.15)" name="Thông báo chuyển trạng thái của nhiệm vụ" time="15 phút trước" />
                            <NotificationItem notRead={!readEvery} icon={docs} mainColor="rgba(255, 175, 55, 0.15)" name="Thông báo chuyển trạng thái của nhiệm vụ" time="15 phút trước" />
                            <NotificationItem icon={clock} mainColor=" rgba(26, 154, 255, 0.15)" name="Thông báo chuyển trạng thái của nhiệm vụ" time="15 phút trước" />
                            <NotificationItem icon={task} mainColor="rgba(224, 224, 224, 0.4)" name="Thông báo chuyển trạng thái của nhiệm vụ" time="15 phút trước" />
                        </>
                    }
                    {!isFull &&
                        (
