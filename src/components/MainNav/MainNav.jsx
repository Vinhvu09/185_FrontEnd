    ...
    return (
        <div className='mainNav'>
            <div className="container-fluid">
                    ...
                    <div className="main">
                        ...
                        <div className="right">
                            <svg width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.0133 5.88369C5.83388 5.88426 5.65426 5.81439 5.51703 5.67424L1.19853 1.26169C0.923814 0.980993 0.922366 0.524489 1.19529 0.242173C1.46811 -0.0401439 1.91197 -0.0415524 2.18671 0.239027L6.00777 4.1435L9.80401 0.214992C10.0769 -0.067325 10.5208 -0.0687334 10.7953 0.211846C11.0702 0.492425 11.0716 0.948929 10.7986 1.23136L6.50822 5.67123C6.37181 5.81227 6.19264 5.88312 6.0133 5.88369Z" fill="#4F5052" />
                            </svg>
                        </div>
                    </div>
                ...
                <NavLink to="/admin/director" className="mainNav__wrapper--noneDropdown">
                    <div className="main">
                        <div className="left">
                            <img src={directer} alt="icon_svg" />
                            <p>Ban giám đốc</p>
                        </div>
                        <div className="circleMainWrapper">
